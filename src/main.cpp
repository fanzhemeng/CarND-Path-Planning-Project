    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // fill in with more points that control speed
          vector<double> ptsx;
          vector<double> ptsy;
          ...
          for (int i=0; i<ptsx.size(); i++) {
            // shift car reference andle to 0 degree
          ...
          int path_total_size = 50;
          for (int i=1; i<=path_total_size - previous_path_x.size(); i++) {
